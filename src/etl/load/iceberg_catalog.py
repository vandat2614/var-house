...
from src.config import (
    ...
    NEON_POSTGRES_URI, R2_ENDPOINT, R2_ACCESS_KEY_ID, R2_SECRET_ACCESS_KEY, R2_BUCKET_NAME
)
...
def get_catalog() -> SqlCatalog:
    ...
    if _catalog is None:
        ...
        if NEON_POSTGRES_URI and R2_ENDPOINT:
            ...
            kwargs["uri"] = uri
            kwargs["warehouse"] = f"s3://{R2_BUCKET_NAME}"
